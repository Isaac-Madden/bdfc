import coachIndy from "../assets/coaches/coach-indy.jpg";
import coachHollie from "../assets/coaches/coach-hollie.jpg";
import coachMo from "../assets/coaches/coach-mo.jpg";
import coachTerry from "../assets/coaches/coach-terry.jpg";
import type { CoachInterface } from "./Types";

export const coachesData: CoachInterface[] = [
    {
        name: "Indy",
